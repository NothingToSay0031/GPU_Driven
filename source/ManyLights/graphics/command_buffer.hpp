...
struct CommandBuffer {
  ...
  void draw_mesh_task_indirect(BufferHandle argument_buffer, u32 argument_offset,
  ...
  void buffer_barrier(BufferHandle buffer, ResourceState old_state, ResourceState new_state,
