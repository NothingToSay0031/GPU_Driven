...
struct Light {
  ...
  vec3s color;
  f32 intensity;
  Light() : world_position{0.f, 0.f, 0.f}, radius{0.f}, color{1.f, 1.f, 1.f}, intensity{1.f} {}
};  // struct Light
...
struct RenderScene {
  ...
  virtual void init(cstring filename, cstring path, Allocator* resident_allocator,
