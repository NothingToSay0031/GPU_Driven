...
ExecutionBarrier& ExecutionBarrier::set(PipelineStage::Enum source,
                                        PipelineStage::Enum destination) {
...
VkImageType to_vk_image_type(TextureType::Enum type) {
  static VkImageType s_vk_target[TextureType::Count] = {VK_IMAGE_TYPE_1D, VK_IMAGE_TYPE_2D,
                                                        VK_IMAGE_TYPE_3D, VK_IMAGE_TYPE_1D,
...
void util_add_image_barrier_ext(GpuDevice* gpu, VkCommandBuffer command_buffer, VkImage image,
                                ...
                                u32 base_mip_level, u32 mip_count, bool is_depth, u32 source_family,
...
void util_add_image_barrier_ext(GpuDevice* gpu, VkCommandBuffer command_buffer, Texture* texture,
  ...
  util_add_image_barrier_ext(gpu, command_buffer, texture->vk_image, texture->state, new_state,
                             base_mip_level, mip_count, is_depth, source_family, destination_family,
