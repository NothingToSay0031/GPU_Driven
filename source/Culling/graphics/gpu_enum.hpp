...
enum Enum { Immutable, Dynamic, Stream, Staging, Count };
...
enum Enum { Default, RenderTarget, Compute, Count };

enum Mask { Default_mask = 1 << 0, RenderTarget_mask = 1 << 1, Compute_mask = 1 << 2 };
